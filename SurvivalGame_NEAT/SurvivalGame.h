...
public:
	...
	// GAME
	static bool step(GameEntities&, bool mousePressed, float mousePosX, float mousePosY,
	                 float verticalMovement, float horizontalMovement, int buttonUpgrade, float elapsedTime);
