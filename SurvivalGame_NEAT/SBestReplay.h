...
static double fitnessFunc(const NEAT::Network &net,
...
class SBestReplay : public SurvivalGame
{
  public:
    ...
    stepAI(GameEntities &AI, const NEAT::Network &net, float fElapsedTime);
  ...
  private:
    ...
    NEAT::Image *image; // needs to ba a pointer because NEAT::Image construtor
                        // doesnt take an evolver that hasnt started yet
